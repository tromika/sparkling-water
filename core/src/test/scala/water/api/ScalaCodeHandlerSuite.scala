...
class ScalaCodeHandlerSuite extends FunSuite with SparkTestContext {
  ...
  ignore("ScalaCodeHandler.interpret() method, using previously defined class"){
    val scalaCodeHandler = new ScalaCodeHandler(sc,h2oContext)
  ...
  ignore("ScalaCodeHandler.interpret() method, using sqlContext,h2oContext and sparkContext"){
    val scalaCodeHandler = new ScalaCodeHandler(sc,h2oContext)
